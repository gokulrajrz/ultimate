<template>
  <div class="container bg-white mb-15 shadow-[0px_4px_4px_0px_#00000026] px-0">
    <div
      class="border-4 border-primary-color shadow-[4px_0px_4px_0px_#00000040]"
    ></div>
    <div class="my-11 grid grid-cols-1 lg:grid-cols-2 px-9">
      <div class="flex justify-center items-center">
        <i-v-location class="text-primary-color mt-1" />
        <div class="text-base ml-3 mb-4 lg:hidden">
          <div class="font-bold text-center">
            ULTIMATE METAL EQUIPMENTS AND TOOLS TRADING L.L.C
          </div>
          <div class="text-center">OFFICE: 07, PLOT NO: 92, </div>
          <div class="text-center">MUSSAFAH: M37,</div>
          <div class="text-center">PO BOX NO: 8465, ABUDHABI - UAE</div>
        </div>

        <div class="text-base ml-3 hidden lg:block">
          <div class="font-bold">
            ULTIMATE METAL EQUIPMENTS AND TOOLS TRADING L.L.C
          </div>
